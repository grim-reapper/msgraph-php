...
class Container_3f4ab8d4d6 extends _PHPStan_cb0c60bf1\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_3f4ab8d4d6 $container)
			{
	...
	public function createServiceContainer(): Container_3f4ab8d4d6
	{
		return $this;
	}
