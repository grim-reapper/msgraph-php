...
// source: phar://D:\laragon\www\msgraph\vendor\phpstan\phpstan\phpstan.phar/conf/config.level5.neon
...
class Container_f227cb479b extends _PHPStan_cb0c60bf1\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f227cb479b $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'D:\laragon\www\msgraph\.phpstan/resultCache.php',
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('D:\laragon\www\msgraph\.phpstan/resultCache.php');
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('D:\laragon\www\msgraph\.phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_f227cb479b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'memoryLimitFile' => 'D:\laragon\www\msgraph\.phpstan/.memory_limit',
			'tempResultCachePath' => 'D:\laragon\www\msgraph\.phpstan/resultCaches',
			'resultCachePath' => 'D:\laragon\www\msgraph\.phpstan/resultCache.php',
			...
			'__validate' => true,
			'tmpDir' => 'D:\laragon\www\msgraph\.phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => 'D:\laragon\www\msgraph\.phpstan',
